...
public class BaseAction : IBaseAction
{
    ...
    /// <inheritdoc/>
    public bool CanUse(out IAction act, bool isLastAbility = false, bool isFirstAbility = false, bool skipSelfStatusProvideCheck = false, bool skipTargetStatusProvideCheck = false, bool skipComboCheck = false, bool skipCastingCheck = false,
    bool usedUp = false, bool skipAoeCheck = false, bool skipTTKCheck = false, byte gcdCountForAbility = 0)
    {
        ...
        if (!Info.BasicCheck(skipSelfStatusProvideCheck, skipTargetStatusProvideCheck, skipComboCheck, skipCastingCheck)) return false;
        ...
        PreviewTarget = TargetInfo.FindTarget(skipAoeCheck, skipSelfStatusProvideCheck, skipTargetStatusProvideCheck);
