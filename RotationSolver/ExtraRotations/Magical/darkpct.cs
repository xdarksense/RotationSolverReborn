...
public sealed class DarkPct : PictomancerRotation
    {
        ...
        protected override bool AttackAbility(IAction nextGCD, out IAction? act)
        {
            ...
            if (RetributionOfTheMadeenPvE.CanUse(out act) && HasStarryMuse)
            {
                return true;
            }
            ...
            if (StrikingMusePvE.CanUse(out act) && StrikingMusePvE.Cooldown.CurrentCharges < 2 && SteelMusePvE.Cooldown.CurrentCharges < 2)
            {
                return false;
            }
